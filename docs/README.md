...
10. [데이터셋 추가 실행 설계](01_data_understanding/DATASET_ADDITION_IMPLEMENTATION_PLAN.md)
11. [외부 검증 요약](04_evaluation_validation/EXTERNAL_VALIDATION_SUMMARY.md)
...
12. [규칙 기반 판단 가이드](03_modeling_and_rules/DOMAIN_RULE_GUIDANCE.md)
11-1. [농장별 상대 threshold 설계안](03_modeling_and_rules/FARM_RELATIVE_THRESHOLD_DESIGN.md)
13. [위험 카테고리 경보](05_operations_feedback/RISK_CATEGORY_ALERTS.md)
